			...
			<div className="independent-student-content-area">
				<div className="create-test-container">
					...
					{courseData.map((domain, index) => (
						<div
							key={index}
							className="indipendent-student-create-test-domain-section"
						>
							<h2 className="indipendent-student-create-test-domain-section-h2">
								{domain.domainName}
							</h2>
					...
					<div className="total-weight-section">
						...
						<input
							className="independent-student-total-weight"
							type="text"
							value={totalWeight}
							readOnly
						/>
