...
const IndStudentCourseDets = () => {
  ...
  const exploreCourses = [
    ...
    { title: 'CompTIA Penetration Testing', image: '/assets/Comptia-PenTest-course.png' }
  ];
            ...
            <div className="upper-half">
              ...
              <div className="course-details">
                ...
                <div className="course-info">
                  ...
                  <button onClick={() => navigate("/IndStudentCreateTest")} className="generate-test-button">
                    Generate Test
                  </button>
                </div>
              </div>
              ...
              <div className="courses-grid">
                {exploreCourses.map((exploreCourse, index) => (
                  <div key={index} className="course-card">
                    <img src={exploreCourse.image} alt={exploreCourse.title} className="course-image" />
